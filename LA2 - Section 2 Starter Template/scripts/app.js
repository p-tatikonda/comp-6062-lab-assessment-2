...
const app = Vue.createApp({
    ...
    data() {
        return {
            studentFullName : 'Priyanka Tatikonda' ,
            waterLevelValue : 65,
            waterLevels: [
                { id: 'danger-low', color: 'danger', label: 'Danger - Low Water Levels!',   min: 0, max: 10 },
                { id: 'warn-low', color: 'warning', label: 'Warning - Low Water Levels', min: 11, max: 30 },
